          ...
          <div className="mx-auto flex max-w-lg flex-col items-center text-center">
            ...
            <div className="mt-6 flex w-full shrink-0 items-center gap-x-3 sm:w-auto">
              <button
                ...
                className="dark:border-border flex w-1/2 items-center justify-center gap-x-2 rounded-lg border bg-white px-5 py-2 text-sm text-neutral-700 transition-colors duration-200 hover:bg-neutral-100 sm:w-auto dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800">
                Try again
              </button>
            </div>
          </div>
